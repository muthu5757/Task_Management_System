...
public class DisplayEmployee implements DisplayAuthority {

    public void Display(List<Employee> employee){
        Iterator<Employee> iterator = employee.listIterator();
        System.out.println("\n ===================================================================\n");
        System.out.println(" |                              Employees List 👨‍💻️                   |");
        System.out.println("\n ====================================================================\n");
    ...
    public void TaskDisplay(Map<Employee, Task> task, Employee employee, String Query)
    {
        ...
        while(true){
            ...
            {
                new DisplayTaskFilter().Display(new TaskFilter().taskfilter(Query,employee));
            }
            else break;
        }
    }
