...
public class DisplayTeamLeader implements DisplayAuthority {
    public void Display(List<Employee> teamleader){
        Iterator<Employee> iterator = teamleader.listIterator();
        System.out.println("\n ===================================================================\n");
        System.out.println(" |                              TeamLeaders List 👨‍💻️                   |");
        System.out.println("\n ====================================================================\n");
    ...
    public void TaskDisplay(Map<Employee, Task> task, Employee teamleader, String Query)
    {
        Scanner in = ObjectCreation.getInstanceofScanner();
            ...
            while(true){
                ...
                {
                    new DisplayTaskFilter().Display(new TaskFilter().taskfilter(Query,teamleader));
                }
                else break;
            }
        }
